...
just so you know what you're dealing with - you never know if the keys will get carried into deeper 
...
for (const val of data) {
    ...
    if (val > prevMeasurement) {
        ++counter
    }
    prevMeasurement = val
}

console.log(`The depth increased ${counter} times`)