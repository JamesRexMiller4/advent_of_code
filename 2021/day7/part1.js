...
You could choose any horizontal position to align them all on, but the one that costs 
...
const findBestFuelSpotBruteForce = (arr) => {
    ...
    for (let i = min; i < max; i++) {
        const cost  = arr.map(val => Math.abs(val - i))
...
console.log(findBestFuelSpotBruteForce(data))